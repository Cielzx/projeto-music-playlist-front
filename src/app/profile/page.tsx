...
const ProfilePage = () => {
  ...
  return (
    <main className="flex  min-h-screen  items-center text-white backgroundDash">
        ...
        <div className=" bg-[#120a8f] bg-opacity-10 w-full p-4 text-white rounded-lg border-2 border-blue-300">
          <div className="flex flex-col gap-6">
            <div className="flex justify-between w-full">
              <div className="w-24 h-24 bg-pink-400 text-2xl  rounded-full bg-gray-900">
                {user.profile_image ? (
                  <img
              ...
              {user.profile_image ? (
                <>
                  ...
                  >
                    ...
                    <p className="text-2xl">Atualizar foto de perfil</p>
                  </button>
                </>
              ) : (
                <>
                  ...
                  >
                    <AiOutlineUpload className="text-3xl" />{" "}
                    <p className="text-2xl">Adicionar foto de perfil</p>
                  </button>
                </>
              )}
            </div>
                ...
                <div className="flex flex-col w-full gap-4">
                  {mode === "name" ? (
                    ...
                    >
                      ...
                      <button className="w-[300px] h-[50px] border-2 border-blue-200 rounded-lg text-xl ">
                        Atualizar
                      </button>
                    </form>
                  ) : (
        ...
        <div className="border-2 border-blue-300 text-white w-full  p-4 text-black rounded-lg">
          <div className="flex flex-col gap-8">
            <div className="w-full flex justify-between">
              <h2 className="text-3xl">Suas músicas</h2>
              <button
                onClick={() => {
                  setMode("music");
                  onOpen();
